...
- **Merge Commit:**\
  When merging, use a merge commit to preserve the full commit history. This ensures that all individual commits are retained, providing a detailed history of changes. Delete the branch after merging.
- **Merge Conflicts:**\
